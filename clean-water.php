...
<script type="text/javascript">
  $(document).ready(function() {
    $("#details-header .button").click(function(){
      $("#details-header .button, #details .tab-content").removeClass("current");
...
<div id="details">
  <div id="tab1" class="tab-content current">
    ...
    <div class="images">
      <div style="background-image: url(images/safewater-details1.jpg);"></div>
  ...
  <div id="tab2" class="tab-content">
    ...
    <div class="images">
      <div style="background-image: url(images/cleanwater-tab2-details1.jpg);"></div>
      <div style="background-image: url(images/cleanwater-tab2-details2.jpg);"></div>
    </div> <!-- /.images -->
  </div> <!-- /#tab2 -->
</div> <!-- /#details -->
